...
var ContextView = /** @class */ (function (_super) {
  ...
  ContextView.prototype.setContainer = function (container) {
    ...
    if (container) {
      ...
      ContextView.BUBBLE_UP_EVENTS.forEach(function (event) {
        toDisposeOnSetContainer_1.add(
          DOM.addStandardDisposableListener(_this.container, event, function (
            e
          ) {
  ...
  ContextView.prototype.doLayout = function () {
    ...
    var verticalAnchor = {
      ...
      size: around.height,
      position:
        anchorPosition === 0 /* BELOW */ ? 0 /* Before */ : 1 /* After */,
    };
    ...
    var top =
      layout(window.innerHeight, viewSizeHeight, verticalAnchor) +
      window.pageYOffset;
