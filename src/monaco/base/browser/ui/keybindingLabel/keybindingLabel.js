...
var KeybindingLabel = /** @class */ (function () {
  ...
  KeybindingLabel.prototype.renderPart = function (parent, part, match) {
    ...
    if (part.ctrlKey) {
      this.renderKey(
        ...
        Boolean(match === null || match === void 0 ? void 0 : match.ctrlKey),
    ...
    if (part.shiftKey) {
      this.renderKey(
        ...
        Boolean(match === null || match === void 0 ? void 0 : match.shiftKey),
        modifierLabels.separator
      );
    }
    if (part.altKey) {
      this.renderKey(
        ...
        Boolean(match === null || match === void 0 ? void 0 : match.altKey),
        modifierLabels.separator
      );
    }
    if (part.metaKey) {
      this.renderKey(
        ...
        Boolean(match === null || match === void 0 ? void 0 : match.metaKey),
        modifierLabels.separator
      );
    }
    ...
    if (keyLabel) {
      this.renderKey(
        parent,
        keyLabel,
        Boolean(match === null || match === void 0 ? void 0 : match.keyCode),
        ''
      );
    }
  };
  KeybindingLabel.prototype.renderKey = function (
    parent,
    label,
    highlight,
    separator
    ...
    dom.append(
      parent,
      $(
        'span.monaco-keybinding-key' + (highlight ? '.highlight' : ''),
        undefined,
        label
      )
    );
  ...
  KeybindingLabel.prototype.renderUnbound = function (parent) {
    dom.append(
      parent,
      $('span.monaco-keybinding-key', undefined, localize('unbound', 'Unbound'))
    );
  };
