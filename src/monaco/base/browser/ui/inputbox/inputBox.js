...
var InputBox = /** @class */ (function (_super) {
  ...
  function InputBox(container, contextViewProvider, options) {
    ...
    _this.inputValidationInfoBackground =
      _this.options.inputValidationInfoBackground;
    _this.inputValidationInfoForeground =
      _this.options.inputValidationInfoForeground;
    _this.inputValidationWarningBorder =
      _this.options.inputValidationWarningBorder;
    _this.inputValidationWarningBackground =
      _this.options.inputValidationWarningBackground;
    _this.inputValidationWarningForeground =
      _this.options.inputValidationWarningForeground;
    _this.inputValidationErrorBorder = _this.options.inputValidationErrorBorder;
    _this.inputValidationErrorBackground =
      _this.options.inputValidationErrorBackground;
    _this.inputValidationErrorForeground =
      _this.options.inputValidationErrorForeground;
    ...
    if (_this.options.flexibleHeight) {
      _this.maxHeight =
        typeof _this.options.flexibleMaxHeight === 'number'
          ? _this.options.flexibleMaxHeight
      ...
      var onSelectionChange = Event.filter(
        domEvent(document, 'selectionchange'),
        function () {
          var selection = document.getSelection();
          return (
            (selection === null || selection === void 0
              ? void 0
              : selection.anchorNode) === wrapper
          );
        }
      );
      ...
      _this._register(
        _this.onDidHeightChange(_this.updateScrollDimensions, _this)
      );
    } else {
  ...
  Object.defineProperty(InputBox.prototype, 'width', {
    ...
    set: function (width) {
      if (this.options.flexibleHeight && this.options.flexibleWidth) {
        ...
        if (this.mirror) {
          var paddingLeft =
            parseFloat(this.mirror.style.paddingLeft || '') || 0;
          var paddingRight =
  ...
  InputBox.prototype.style = function (styles) {
    ...
    this.inputValidationWarningForeground =
      styles.inputValidationWarningForeground;
  ...
  InputBox.prototype.applyStyles = function () {
    var background = this.inputBackground
      ...
      : '';
    var foreground = this.inputForeground
...
var HistoryInputBox = /** @class */ (function (_super) {
  ...
  function HistoryInputBox(container, contextViewProvider, options) {
    var _this =
      _super.call(this, container, contextViewProvider, options) || this;
