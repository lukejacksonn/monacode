...
var NLS_PRESERVE_CASE_LABEL = nls.localize(
...
var ReplaceInput = /** @class */ (function (_super) {
  ...
  function ReplaceInput(
    ...
    _this.preserveCase = _this._register(
      new PreserveCaseCheckbox({
        appendTitle: '',
        isChecked: false,
    ...
    _this._register(
      _this.preserveCase.onChange(function (viaKeyboard) {
    ...
    _this._register(
      _this.preserveCase.onKeyDown(function (e) {
