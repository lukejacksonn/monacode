...
var MouseWheelClassifier = /** @class */ (function () {
  ...
  MouseWheelClassifier.prototype.isPhysicalMouseWheel = function () {
    ...
    do {
      var influence =
        index === this._front ? remainingInfluence : Math.pow(2, -iteration);
  ...
  MouseWheelClassifier.prototype._computeScore = function (item) {
    ...
    if (
      Math.abs(item.deltaX - Math.round(item.deltaX)) > 0 ||
      Math.abs(item.deltaY - Math.round(item.deltaY)) > 0
    ) {
...
var AbstractScrollableElement = /** @class */ (function (_super) {
  ...
  function AbstractScrollableElement(element, options, scrollable) {
    ...
    _this._register(
      _this._scrollable.onScroll(function (e) {
    ...
    _this._verticalScrollbar = _this._register(
      new VerticalScrollbar(_this._scrollable, _this._options, scrollbarHost)
    );
    _this._horizontalScrollbar = _this._register(
      new HorizontalScrollbar(_this._scrollable, _this._options, scrollbarHost)
    );
    _this._domNode = document.createElement('div');
    _this._domNode.className =
      'monaco-scrollable-element ' + _this._options.className;
   ...
   */
  AbstractScrollableElement.prototype.delegateVerticalScrollbarMouseDown = function (
    browserEvent
  ) {
  ...
  AbstractScrollableElement.prototype.setScrollDimensions = function (
    dimensions
  ) {
   ...
   */
  AbstractScrollableElement.prototype.updateClassName = function (
    newClassName
  ) {
  ...
  AbstractScrollableElement.prototype._setListeningToMouseWheel = function (
    shouldListen
  ) {
    var _this = this;
  ...
  AbstractScrollableElement.prototype._onMouseWheel = function (e) {
    ...
    if (e.deltaY || e.deltaX) {
      ...
      var shiftConvert =
        !platform.isMacintosh && e.browserEvent && e.browserEvent.shiftKey;
      ...
      if (deltaY) {
        var desiredScrollTop =
          futureScrollPosition.scrollTop - SCROLL_WHEEL_SENSITIVITY * deltaY;
      ...
      if (deltaX) {
        var desiredScrollLeft =
          futureScrollPosition.scrollLeft - SCROLL_WHEEL_SENSITIVITY * deltaX;
...
function resolveOptions(opts) {
  var result = {
    lazyRender:
      typeof opts.lazyRender !== 'undefined' ? opts.lazyRender : false,
    className: typeof opts.className !== 'undefined' ? opts.className : '',
    useShadows: typeof opts.useShadows !== 'undefined' ? opts.useShadows : true,
    handleMouseWheel:
      typeof opts.handleMouseWheel !== 'undefined'
        ? opts.handleMouseWheel
        : true,
    flipAxes: typeof opts.flipAxes !== 'undefined' ? opts.flipAxes : false,
    alwaysConsumeMouseWheel:
      typeof opts.alwaysConsumeMouseWheel !== 'undefined'
        ? opts.alwaysConsumeMouseWheel
        : false,
    scrollYToX:
      typeof opts.scrollYToX !== 'undefined' ? opts.scrollYToX : false,
    mouseWheelScrollSensitivity:
      typeof opts.mouseWheelScrollSensitivity !== 'undefined'
        ? opts.mouseWheelScrollSensitivity
        : 1,
    fastScrollSensitivity:
      typeof opts.fastScrollSensitivity !== 'undefined'
        ? opts.fastScrollSensitivity
        : 5,
    mouseWheelSmoothScroll:
      typeof opts.mouseWheelSmoothScroll !== 'undefined'
        ? opts.mouseWheelSmoothScroll
        : true,
    arrowSize: typeof opts.arrowSize !== 'undefined' ? opts.arrowSize : 11,
    listenOnDomNode:
      typeof opts.listenOnDomNode !== 'undefined' ? opts.listenOnDomNode : null,
    horizontal:
      typeof opts.horizontal !== 'undefined' ? opts.horizontal : 1 /* Auto */,
    ...
    horizontalSliderSize:
      typeof opts.horizontalSliderSize !== 'undefined'
        ...
        : 0,
    horizontalHasArrows:
      typeof opts.horizontalHasArrows !== 'undefined'
        ? opts.horizontalHasArrows
        : false,
    vertical:
      typeof opts.vertical !== 'undefined' ? opts.vertical : 1 /* Auto */,
