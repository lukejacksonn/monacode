...
} from '../../common/viewModel/viewModel.js';
...
var VisualEditorState = /** @class */ (function () {
  ...
  VisualEditorState.prototype.apply = function (
    editor,
    overviewRuler,
    newDecorations,
    restoreScrollState
    ...
    var _this = this;
    var scrollState = restoreScrollState
      ? StableEditorScrollState.capture(editor)
      : null;
    // view zones
    editor.changeViewZones(function (viewChangeAccessor) {
      ...
      for (
        var i = 0, length_3 = _this.inlineDiffMargins.length;
        i < length_3;
        i++
      ) {
      ...
      for (
        var i = 0, length_4 = newDecorations.zones.length;
        i < length_4;
        i++
      ) {
        ...
        if (
          newDecorations.zones[i].diff &&
          viewZone.marginDomNode &&
          _this._clipboardService
        ) {
          viewZone.suppressMouseDown = false;
          _this.inlineDiffMargins.push(
            new InlineDiffMargin(
              zoneId,
              viewZone.marginDomNode,
              editor,
              newDecorations.zones[i].diff,
              _this._contextMenuService,
              _this._clipboardService
            )
          );
        }
...
var DiffEditorWidget = /** @class */ (function (_super) {
  ...
  function DiffEditorWidget(
    ...
    _this._contextKeyService = _this._register(
      contextKeyService.createScoped(domElement)
    );
    ...
    _this._updateDecorationsRunner = _this._register(
      new RunOnceScheduler(function () {
        return _this._updateDecorations();
      }, 0)
    );
    _this._containerDomElement = document.createElement('div');
    _this._containerDomElement.className = DiffEditorWidget._getClassName(
      _this._themeService.getTheme(),
      _this._renderSideBySide
    );
    ...
    _this._overviewViewportDomElement = createFastDomNode(
    ...
    _this._overviewDomElement.appendChild(
      _this._overviewViewportDomElement.domNode
    );
    _this._register(
      dom.addStandardDisposableListener(
        _this._overviewDomElement,
        'mousedown',
        function (e) {
    ...
    _this._elementSizeObserver = _this._register(
      new ElementSizeObserver(
        _this._containerDomElement,
        undefined,
        function () {
    ...
    var leftScopedInstantiationService = instantiationService.createChild(
      leftServices
    );
    ...
    var rightScopedInstantiationService = instantiationService.createChild(
      rightServices
    );
    _this.originalEditor = _this._createLeftHandSideEditor(
      options,
      leftScopedInstantiationService
    );
    _this.modifiedEditor = _this._createRightHandSideEditor(
      options,
    ...
    _this._containerDomElement.appendChild(
      _this._reviewPane.actionBarContainer.domNode
    );
    ...
    if (_this._renderSideBySide) {
      _this._setStrategy(
        new DiffEditorWidgetSideBySide(
    ...
    for (
      var _i = 0, contributions_1 = contributions;
      _i < contributions_1.length;
      _i++
    ) {
  ...
  DiffEditorWidget.prototype._createLeftHandSideEditor = function (
    options,
    instantiationService
  ) {
    var _this = this;
    var editor = this._createInnerEditor(
      instantiationService,
    ...
    this._register(
      editor.onDidChangeViewZones(function () {
  ...
  DiffEditorWidget.prototype._createRightHandSideEditor = function (
    options,
    instantiationService
  ) {
    var _this = this;
    ...
    this._register(
      editor.onDidChangeModelOptions(function (e) {
        if (e.tabSize) {
          _this._updateDecorationsRunner.schedule();
        }
      })
  ...
  DiffEditorWidget.prototype._createInnerEditor = function (
    instantiationService,
    container,
    options
  ) {
  ...
  DiffEditorWidget.prototype.dispose = function () {
    ...
    this._containerDomElement.removeChild(
      this._reviewPane.actionBarContainer.domNode
    );
  ...
  DiffEditorWidget.prototype.getVisibleColumnFromPosition = function (
    position
  ) {
  ...
  DiffEditorWidget.prototype.revealLineInCenter = function (
    lineNumber,
    scrollType
  ) {
    if (scrollType === void 0) {
  ...
  DiffEditorWidget.prototype.revealLineInCenterIfOutsideViewport = function (
    lineNumber,
    scrollType
  ) {
    if (scrollType === void 0) {
    ...
    this.modifiedEditor.revealLineInCenterIfOutsideViewport(
      lineNumber,
      scrollType
    );
  };
  ...
  DiffEditorWidget.prototype.revealPositionInCenter = function (
    position,
    scrollType
  ) {
    if (scrollType === void 0) {
  ...
  DiffEditorWidget.prototype.revealPositionInCenterIfOutsideViewport = function (
    position,
    scrollType
  ) {
    if (scrollType === void 0) {
    ...
    this.modifiedEditor.revealPositionInCenterIfOutsideViewport(
      position,
      scrollType
    );
  };
  ...
  DiffEditorWidget.prototype.revealLines = function (
    startLineNumber,
    endLineNumber,
    scrollType
  ) {
  ...
  DiffEditorWidget.prototype.revealLinesInCenter = function (
    startLineNumber,
    endLineNumber,
    scrollType
  ) {
    ...
    this.modifiedEditor.revealLinesInCenter(
      startLineNumber,
      endLineNumber,
      scrollType
    );
  };
  DiffEditorWidget.prototype.revealLinesInCenterIfOutsideViewport = function (
    startLineNumber,
    endLineNumber,
    scrollType
  ) {
  ...
  DiffEditorWidget.prototype.revealRange = function (
    range,
    scrollType,
  ...
  DiffEditorWidget.prototype.revealRangeInCenter = function (
    range,
    scrollType
  ) {
    if (scrollType === void 0) {
  ...
  DiffEditorWidget.prototype.revealRangeInCenterIfOutsideViewport = function (
    range,
    scrollType
  ) {
    if (scrollType === void 0) {
  ...
  DiffEditorWidget.prototype.hasTextFocus = function () {
    return (
      this.originalEditor.hasTextFocus() || this.modifiedEditor.hasTextFocus()
    );
  };
  ...
  DiffEditorWidget.prototype._getReviewHeight = function () {
    return this._reviewPane.isVisible()
      ? this._elementSizeObserver.getHeight()
      : 0;
  };
  ...
  DiffEditorWidget.prototype._beginUpdateDecorations = function () {
    ...
    if (
      !this._editorWorkerService.canComputeDiff(
        currentOriginalModel.uri,
        currentModifiedModel.uri
      )
    ) {
      if (
        !DiffEditorWidget._equals(
          currentOriginalModel.uri,
          this._lastOriginalWarning
        ) ||
        !DiffEditorWidget._equals(
          currentModifiedModel.uri,
          this._lastModifiedWarning
        )
      ) {
    ...
    this._editorWorkerService
      ...
      .then(
        function (result) {
          if (
            currentToken === _this._diffComputationToken &&
  ...
  DiffEditorWidget.prototype._updateDecorations = function () {
    if (
      !this.originalEditor.getModel() ||
      !this.modifiedEditor.getModel() ||
      !this._originalOverviewRuler ||
      !this._modifiedOverviewRuler
    ) {
      return;
    }
    var lineChanges = this._diffComputationResult
      ? this._diffComputationResult.changes
      : [];
    var foreignOriginal = this._originalEditorState.getForeignViewZones(
      this.originalEditor.getWhitespaces()
    );
    var foreignModified = this._modifiedEditorState.getForeignViewZones(
      this.modifiedEditor.getWhitespaces()
    );
    var diffDecorations = this._strategy.getEditorsDiffDecorations(
      lineChanges,
      this._ignoreTrimWhitespace,
  ...
  DiffEditorWidget.prototype._adjustOptionsForLeftHandSide = function (
    options,
    isEditable
  ) {
  ...
  DiffEditorWidget.prototype._adjustOptionsForRightHandSide = function (
    options
  ) {
    var result = this._adjustOptionsForSubEditor(options);
  ...
  DiffEditorWidget.prototype._doLayout = function () {
    ...
    this._overviewDomElement.style.left =
      width - DiffEditorWidget.ENTIRE_DIFF_OVERVIEW_WIDTH + 'px';
  ...
  DiffEditorWidget.prototype._computeOverviewViewport = function () {
    ...
    var computedRatio =
      scrollHeight > 0 ? computedRepresentableSize / scrollHeight : 0;
    var computedSliderSize = Math.max(
      0,
      Math.floor(layoutInfo.height * computedRatio)
    );
  ...
  DiffEditorWidget.prototype._createDataSource = function () {
    ...
    return {
      ...
      getHeight: function () {
        return (
          _this._elementSizeObserver.getHeight() - _this._getReviewHeight()
        );
      },
  ...
  DiffEditorWidget.prototype._getLineChangeAtOrBeforeLineNumber = function (
    lineNumber,
    ...
    if (
      ...
      lineNumber < startLineNumberExtractor(lineChanges[0])
    ) {
    ...
    while (min < max) {
      ...
      var midEnd =
        mid + 1 <= max
          ? startLineNumberExtractor(lineChanges[mid + 1])
  ...
  DiffEditorWidget.prototype._getEquivalentLineForOriginalLineNumber = function (
    lineNumber
  ) {
    var lineChange = this._getLineChangeAtOrBeforeLineNumber(
      lineNumber,
      function (lineChange) {
  ...
  DiffEditorWidget.prototype._getEquivalentLineForModifiedLineNumber = function (
    lineNumber
  ) {
    var lineChange = this._getLineChangeAtOrBeforeLineNumber(
      lineNumber,
  ...
  DiffEditorWidget.prototype.getDiffLineInformationForOriginal = function (
    lineNumber
  ) {
    if (!this._diffComputationResult) {
  ...
  DiffEditorWidget.prototype.getDiffLineInformationForModified = function (
    lineNumber
  ) {
    if (!this._diffComputationResult) {
      // Cannot answer that which I don't know
...
var DiffEditorWidgetStyle = /** @class */ (function (_super) {
  ...
  DiffEditorWidgetStyle.prototype.applyColors = function (theme) {
    ...
    var newRemoveColor = (
      theme.getColor(diffRemoved) || defaultRemoveColor
    ).transparent(2);
    var hasChanges =
  ...
  DiffEditorWidgetStyle.prototype.getEditorsDiffDecorations = function (
    lineChanges,
    ignoreTrimWhitespace,
    renderIndicators,
    originalWhitespaces,
    ...
    var originalDecorations = this._getOriginalEditorDecorations(
      lineChanges,
      ignoreTrimWhitespace,
      renderIndicators,
      originalEditor,
    ...
    var modifiedDecorations = this._getModifiedEditorDecorations(
      lineChanges,
      ignoreTrimWhitespace,
      renderIndicators,
      originalEditor,
...
var ViewZonesComputer = /** @class */ (function () {
  ...
  ViewZonesComputer.prototype.getViewZones = function () {
    ...
    var modifiedForeignVZ = new ForeignViewZonesIterator(
      this.modifiedForeignVZ
    );
    var originalForeignVZ = new ForeignViewZonesIterator(
    ...
    for (var i = 0, length_5 = this.lineChanges.length; i <= length_5; i++) {
      ...
      while (
        ...
        stepOriginal.push({
          ...
          heightInLines:
            modifiedForeignVZ.current.height / this.modifiedLineHeight,
          domNode: null,
      ...
      while (
        ...
        stepModified.push({
          afterLineNumber: viewZoneLineNumber,
          heightInLines:
            originalForeignVZ.current.height / this.originalLineHeight,
          domNode: null,
        });
        originalForeignVZ.advance();
      }
      if (lineChange !== null && isChangeOrInsert(lineChange)) {
        var r = this._produceOriginalFromDiff(
          lineChange,
          lineChangeOriginalLength,
          lineChangeModifiedLength
        );
      ...
      if (lineChange !== null && isChangeOrDelete(lineChange)) {
        var r = this._produceModifiedFromDiff(
          lineChange,
          lineChangeOriginalLength,
          lineChangeModifiedLength
        );
...
var DiffEditorWidgetSideBySide = /** @class */ (function (_super) {
  ...
  function DiffEditorWidgetSideBySide(dataSource, enableSplitViewResizing) {
    ...
    _this._sash = _this._register(
      new Sash(_this._dataSource.getContainerDomNode(), _this)
    );
  ...
  DiffEditorWidgetSideBySide.prototype.setEnableSplitViewResizing = function (
    enableSplitViewResizing
  ) {
  ...
  DiffEditorWidgetSideBySide.prototype.layout = function (sashRatio) {
    ...
    if (contentWidth > DiffEditorWidgetSideBySide.MINIMUM_EDITOR_WIDTH * 2) {
      ...
      if (
        sashPosition >
        contentWidth - DiffEditorWidgetSideBySide.MINIMUM_EDITOR_WIDTH
      ) {
        sashPosition =
          contentWidth - DiffEditorWidgetSideBySide.MINIMUM_EDITOR_WIDTH;
      }
  ...
  DiffEditorWidgetSideBySide.prototype._getViewZones = function (
    lineChanges,
    originalForeignVZ,
    modifiedForeignVZ,
    originalEditor,
    ...
    var c = new SideBySideViewZonesComputer(
      lineChanges,
      originalForeignVZ,
      originalEditor.getOption(49 /* lineHeight */),
      modifiedForeignVZ,
      modifiedEditor.getOption(49 /* lineHeight */)
    );
    return c.getViewZones();
  };
  DiffEditorWidgetSideBySide.prototype._getOriginalEditorDecorations = function (
    lineChanges,
    ignoreTrimWhitespace,
    renderIndicators,
    originalEditor,
    ...
    for (var i = 0, length_6 = lineChanges.length; i < length_6; i++) {
      ...
      if (isChangeOrDelete(lineChange)) {
        ...
        if (lineChange.charChanges) {
          for (
            var j = 0, lengthJ = lineChange.charChanges.length;
            j < lengthJ;
            j++
          ) {
            ...
            if (isChangeOrDelete(charChange)) {
              if (ignoreTrimWhitespace) {
                for (
                  var lineNumber = charChange.originalStartLineNumber;
  ...
  DiffEditorWidgetSideBySide.prototype._getModifiedEditorDecorations = function (
    lineChanges,
    ignoreTrimWhitespace,
    renderIndicators,
    originalEditor,
        ...
        if (lineChange.charChanges) {
          for (
            ...
            if (isChangeOrInsert(charChange)) {
              if (ignoreTrimWhitespace) {
                for (
                  var lineNumber = charChange.modifiedStartLineNumber;
...
var SideBySideViewZonesComputer = /** @class */ (function (_super) {
  ...
  function SideBySideViewZonesComputer(
    lineChanges,
    originalForeignVZ,
    originalLineHeight,
    modifiedForeignVZ,
  ...
  SideBySideViewZonesComputer.prototype._produceModifiedFromDiff = function (
    lineChange,
    lineChangeOriginalLength,
    lineChangeModifiedLength
  ) {
...
var DiffEditorWidgetInline = /** @class */ (function (_super) {
  ...
  function DiffEditorWidgetInline(dataSource, enableSplitViewResizing) {
    var _this = _super.call(this, dataSource) || this;
    _this.decorationsLeft = dataSource
      .getOriginalEditor()
      .getLayoutInfo().decorationsLeft;
    _this._register(
      dataSource.getOriginalEditor().onDidLayoutChange(function (layoutInfo) {
  ...
  DiffEditorWidgetInline.prototype.setEnableSplitViewResizing = function (
    enableSplitViewResizing
  ) {
    // Nothing to do..
  };
  DiffEditorWidgetInline.prototype._getViewZones = function (
    lineChanges,
    originalForeignVZ,
    modifiedForeignVZ,
    originalEditor,
    ...
    var computer = new InlineViewZonesComputer(
      lineChanges,
      originalForeignVZ,
      modifiedForeignVZ,
      originalEditor,
  ...
  DiffEditorWidgetInline.prototype._getOriginalEditorDecorations = function (
    lineChanges,
    ignoreTrimWhitespace,
    renderIndicators,
    originalEditor,
  ...
  DiffEditorWidgetInline.prototype._getModifiedEditorDecorations = function (
    lineChanges,
    ignoreTrimWhitespace,
    renderIndicators,
    originalEditor,
...
var InlineViewZonesComputer = /** @class */ (function (_super) {
  ...
  function InlineViewZonesComputer(
    lineChanges,
    originalForeignVZ,
    modifiedForeignVZ,
    originalEditor,
    ...
    _this.modifiedEditorTabSize = modifiedEditor
      .getModel()
      .getOptions().tabSize;
  ...
  InlineViewZonesComputer.prototype._produceOriginalFromDiff = function (
    lineChange,
    lineChangeOriginalLength,
    lineChangeModifiedLength
  ) {
  ...
  InlineViewZonesComputer.prototype._produceModifiedFromDiff = function (
    lineChange,
    lineChangeOriginalLength,
    lineChangeModifiedLength
  ) {
    ...
    var typicalHalfwidthCharacterWidth =
      fontInfo.typicalHalfwidthCharacterWidth;
    var maxCharsPerLine = 0;
    var originalContent = [];
    for (
      var lineNumber = lineChange.originalStartLineNumber;
      lineNumber <= lineChange.originalEndLineNumber;
      lineNumber++
    ) {
      maxCharsPerLine = Math.max(
        maxCharsPerLine,
        this._renderOriginalLine(
      ...
      if (this.renderIndicators) {
        ...
        marginHTML = marginHTML.concat([
          '<div class="delete-sign codicon codicon-remove" style="position:absolute;top:' +
            index * lineHeight +
            'px;width:' +
    ...
    maxCharsPerLine += this.modifiedEditorOptions.get(
  ...
  InlineViewZonesComputer.prototype._renderOriginalLine = function (
    count,
    originalModel,
    options,
    tabSize,
    ...
    var actualDecorations = LineDecoration.filter(
      decorations,
      lineNumber,
      1,
    ...
    var isBasicASCII = ViewLineRenderingData.isBasicASCII(
      lineContent,
      originalModel.mightContainNonBasicASCII()
    );
    var containsRTL = ViewLineRenderingData.containsRTL(
      lineContent,
      isBasicASCII,
      originalModel.mightContainRTL()
    );
    var output = renderViewLine(
      new RenderLineInput(
        ...
        options.get(88 /* stopRenderingLineAfter */),
        options.get(74 /* renderWhitespace */),
        options.get(69 /* renderControlCharacters */),
        options.get(35 /* fontLigatures */) !== EditorFontLigatures.OFF,
    ...
    return absoluteOffsets.length > 0
      ? absoluteOffsets[absoluteOffsets.length - 1]
      : 0;
  };
...
registerThemingParticipant(function (theme, collector) {
  ...
  if (added) {
    ...
    collector.addRule(
      '.monaco-diff-editor .line-insert, .monaco-diff-editor .char-insert { background-color: ' +
        added +
        '; }'
    );
    collector.addRule(
      '.monaco-editor .inline-added-margin-view-zone { background-color: ' +
        added +
        '; }'
    );
  }
  ...
  if (removed) {
    ...
    collector.addRule(
      '.monaco-diff-editor .line-delete, .monaco-diff-editor .char-delete { background-color: ' +
        removed +
        '; }'
    );
    collector.addRule(
      '.monaco-editor .inline-deleted-margin-view-zone { background-color: ' +
        removed +
        '; }'
    );
  }
  ...
  if (addedOutline) {
    collector.addRule(
      '.monaco-editor .line-insert, .monaco-editor .char-insert { border: 1px ' +
  ...
  if (removedOutline) {
    collector.addRule(
      '.monaco-editor .line-delete, .monaco-editor .char-delete { border: 1px ' +
        (theme.type === 'hc' ? 'dashed' : 'solid') +
        ' ' +
        removedOutline +
        '; }'
  ...
  if (border) {
    collector.addRule(
      '.monaco-diff-editor.side-by-side .editor.modified { border-left: 1px solid ' +
        border +
        '; }'
    );
  }
