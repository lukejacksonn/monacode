...
} from '../../common/view/editorColorRegistry.js';
import {
  editorErrorBorder,
...
var CodeEditorWidget = /** @class */ (function (_super) {
  ...
  function CodeEditorWidget(
    ...
    _this._onDidChangeModelLanguageConfiguration = _this._register(
      new Emitter()
    );
    _this.onDidChangeModelLanguageConfiguration =
      _this._onDidChangeModelLanguageConfiguration.event;
    ...
    _this.onDidChangeModelDecorations =
      _this._onDidChangeModelDecorations.event;
    ...
    options = options || {};
    _this._configuration = _this._register(
      _this._createConfiguration(options, accessibilityService)
    );
    _this._register(
      _this._configuration.onDidChange(function (e) {
    ...
    _this._contextKeyService = _this._register(
      contextKeyService.createScoped(_this._domElement)
    );
    ...
    _this._register(
      new EditorContextKeysManager(_this, _this._contextKeyService)
    );
    ...
    _this._instantiationService = instantiationService.createChild(
      new ServiceCollection([IContextKeyService, _this._contextKeyService])
    );
    ...
    for (
      ...
      try {
        var contribution = _this._instantiationService.createInstance(
          desc.ctor,
          _this
        );
    ...
    EditorExtensionsRegistry.getEditorActions().forEach(function (action) {
      var internalAction = new InternalEditorAction(
        action.id,
        action.label,
        action.alias,
        withNullAsUndefined(action.precondition),
        function () {
          return _this._instantiationService.invokeFunction(function (
            accessor
          ) {
            return Promise.resolve(
              action.runEditorCommand(accessor, _this, null)
            );
          });
        },
  ...
  CodeEditorWidget.prototype._createConfiguration = function (
    options,
    accessibilityService
  ) {
  ...
  CodeEditorWidget._getVerticalOffsetForPosition = function (
    modelData,
    modelLineNumber,
    modelColumn
  ) {
    ...
    var viewPosition = modelData.viewModel.coordinatesConverter.convertModelPositionToViewPosition(
      modelPosition
    );
  ...
  CodeEditorWidget.prototype.getVisibleColumnFromPosition = function (
    rawPosition
  ) {
    if (!this._modelData) {
  ...
  CodeEditorWidget.prototype._sendRevealRange = function (
    modelRange,
    verticalType,
    revealHorizontal,
    scrollType
    ...
    var viewRange = this._modelData.viewModel.coordinatesConverter.convertModelRangeToViewRange(
      validatedModelRange
    );
    this._modelData.cursor.emitCursorRevealRange(
      'api',
      viewRange,
      verticalType,
      revealHorizontal,
  ...
  CodeEditorWidget.prototype.revealLineInCenter = function (
    lineNumber,
    scrollType
  ) {
    if (scrollType === void 0) {
  ...
  CodeEditorWidget.prototype.revealLineInCenterIfOutsideViewport = function (
    lineNumber,
    scrollType
  ) {
    if (scrollType === void 0) {
  ...
  CodeEditorWidget.prototype._revealLine = function (
    lineNumber,
    revealType,
    scrollType
  ) {
  ...
  CodeEditorWidget.prototype.revealPositionInCenter = function (
    position,
    scrollType
  ) {
    if (scrollType === void 0) {
  ...
  CodeEditorWidget.prototype.revealPositionInCenterIfOutsideViewport = function (
    position,
    scrollType
  ) {
    if (scrollType === void 0) {
    ...
    this._revealPosition(
      position,
      2 /* CenterIfOutsideViewport */,
      true,
      scrollType
    );
  };
  CodeEditorWidget.prototype._revealPosition = function (
    position,
    verticalType,
    revealHorizontal,
    scrollType
  ...
  CodeEditorWidget.prototype.revealLines = function (
    startLineNumber,
    endLineNumber,
    scrollType
  ) {
  ...
  CodeEditorWidget.prototype.revealLinesInCenter = function (
    startLineNumber,
    endLineNumber,
    scrollType
  ) {
  ...
  CodeEditorWidget.prototype.revealLinesInCenterIfOutsideViewport = function (
    startLineNumber,
    endLineNumber,
    scrollType
  ) {
  ...
  CodeEditorWidget.prototype._revealLines = function (
    startLineNumber,
    endLineNumber,
    verticalType,
    scrollType
  ...
  CodeEditorWidget.prototype.revealRange = function (
    range,
    scrollType,
    ...
    this._revealRange(
      range,
      revealVerticalInCenter ? 1 /* Center */ : 0 /* Simple */,
      revealHorizontal,
      scrollType
    );
  };
  CodeEditorWidget.prototype.revealRangeInCenter = function (
    range,
    scrollType
  ) {
    if (scrollType === void 0) {
  ...
  CodeEditorWidget.prototype.revealRangeInCenterIfOutsideViewport = function (
    range,
    scrollType
  ) {
    if (scrollType === void 0) {
  ...
  CodeEditorWidget.prototype._revealRange = function (
    range,
    verticalType,
    revealHorizontal,
    scrollType
  ...
  CodeEditorWidget.prototype.restoreViewState = function (s) {
    ...
    if (
      ...
      var reducedState = this._modelData.viewModel.reduceRestoreState(
        codeEditorState.viewState
      );
  ...
  CodeEditorWidget.prototype.trigger = function (source, handlerId, payload) {
    ...
    if (handlerId === editorCommon.Handler.Paste) {
      ...
      var startPosition = this._modelData.cursor
        .getSelection()
        .getStartPosition();
      this._modelData.cursor.trigger(source, handlerId, payload);
      var endPosition = this._modelData.cursor
        .getSelection()
        .getStartPosition();
      if (source === 'keyboard') {
  ...
  CodeEditorWidget.prototype._triggerEditorCommand = function (
    source,
    handlerId,
    payload
  ) {
    ...
    if (command) {
      ...
      this._instantiationService.invokeFunction(function (accessor) {
        Promise.resolve(
          command.runEditorCommand(accessor, _this, payload)
  ...
  CodeEditorWidget.prototype.executeEdits = function (
    source,
    edits,
    endCursorState
  ) {
  ...
  CodeEditorWidget.prototype.executeCommand = function (source, command) {
    ...
    this._modelData.cursor.trigger(
      source,
  ...
  CodeEditorWidget.prototype.executeCommands = function (source, commands) {
    ...
    this._modelData.cursor.trigger(
      source,
      editorCommon.Handler.ExecuteCommands,
      commands
    );
  };
  ...
  CodeEditorWidget.prototype.deltaDecorations = function (
    oldDecorations,
    newDecorations
  ) {
    if (!this._modelData) {
  ...
  CodeEditorWidget.prototype.delegateVerticalScrollbarMouseDown = function (
    browserEvent
  ) {
    if (!this._modelData || !this._modelData.hasRealView) {
      return;
  ...
  CodeEditorWidget.prototype.getTargetAtClientPoint = function (
    clientX,
    clientY
  ) {
    if (!this._modelData || !this._modelData.hasRealView) {
  ...
  CodeEditorWidget.prototype.getScrolledVisiblePosition = function (
    rawPosition
  ) {
    if (!this._modelData || !this._modelData.hasRealView) {
      return null;
  ...
  CodeEditorWidget.prototype.getOffsetForColumn = function (
    lineNumber,
    column
  ) {
    if (!this._modelData || !this._modelData.hasRealView) {
  ...
  CodeEditorWidget.prototype.applyFontInfo = function (target) {
    Configuration.applyFontInfoSlow(
      target,
      this._configuration.options.get(34 /* fontInfo */)
    );
  };
  CodeEditorWidget.prototype._attachModel = function (model) {
    ...
    listenersToRemove.push(
      model.onDidChangeLanguage(function (e) {
        _this._domElement.setAttribute(
          'data-mode-id',
          model.getLanguageIdentifier().language
        );
    ...
    listenersToRemove.push(
      model.onDidChangeLanguageConfiguration(function (e) {
    ...
    listenersToRemove.push(
      model.onDidChangeOptions(function (e) {
    ...
    listenersToRemove.push(
      cursor.onDidReachMaxCursorCount(function () {
        _this._notificationService.warn(
          nls.localize(
            'cursors.maximum',
            'The number of cursors has been limited to {0}.',
            Cursor.MAX_CURSOR_COUNT
          )
        );
      })
    );
    listenersToRemove.push(
      cursor.onDidAttemptReadOnlyEdit(function () {
        _this._onDidAttemptReadOnlyEdit.fire(undefined);
      })
    );
    listenersToRemove.push(
      cursor.onDidChange(function (e) {
        var positions = [];
  ...
  CodeEditorWidget.prototype._postDetachModelCleanup = function (
    detachedModel
  ) {
    if (detachedModel) {
  ...
  CodeEditorWidget.prototype._detachModel = function () {
    ...
    var removeDomNode = this._modelData.hasRealView
...
var EditorContextKeysManager = /** @class */ (function (_super) {
  ...
  function EditorContextKeysManager(editor, contextKeyService) {
    ...
    _this._editorSimpleInput = EditorContextKeys.editorSimpleInput.bindTo(
      contextKeyService
    );
    _this._editorFocus = EditorContextKeys.focus.bindTo(contextKeyService);
    _this._textInputFocus = EditorContextKeys.textInputFocus.bindTo(
      contextKeyService
    );
    _this._editorTextFocus = EditorContextKeys.editorTextFocus.bindTo(
      contextKeyService
    );
    _this._editorTabMovesFocus = EditorContextKeys.tabMovesFocus.bindTo(
      contextKeyService
    );
    _this._editorReadonly = EditorContextKeys.readOnly.bindTo(
      contextKeyService
    );
    _this._hasMultipleSelections = EditorContextKeys.hasMultipleSelections.bindTo(
      contextKeyService
    );
    _this._hasNonEmptySelection = EditorContextKeys.hasNonEmptySelection.bindTo(
      contextKeyService
    );
    ...
    _this._register(
      _this._editor.onDidChangeConfiguration(function () {
        return _this._updateFromConfig();
      })
    );
    _this._register(
      _this._editor.onDidChangeCursorSelection(function () {
        return _this._updateFromSelection();
      })
    );
    _this._register(
      _this._editor.onDidFocusEditorWidget(function () {
        return _this._updateFromFocus();
      })
    );
    _this._register(
      _this._editor.onDidBlurEditorWidget(function () {
        return _this._updateFromFocus();
      })
    );
    _this._register(
      _this._editor.onDidFocusEditorText(function () {
        return _this._updateFromFocus();
      })
    );
    _this._register(
      _this._editor.onDidBlurEditorText(function () {
        return _this._updateFromFocus();
      })
    );
    _this._register(
      _this._editor.onDidChangeModel(function () {
...
var EditorModeContext = /** @class */ (function (_super) {
  ...
  function EditorModeContext(_editor, _contextKeyService) {
    ...
    _this._hasCompletionItemProvider = EditorContextKeys.hasCompletionItemProvider.bindTo(
      _contextKeyService
    );
    _this._hasCodeActionsProvider = EditorContextKeys.hasCodeActionsProvider.bindTo(
      _contextKeyService
    );
    _this._hasCodeLensProvider = EditorContextKeys.hasCodeLensProvider.bindTo(
      _contextKeyService
    );
    _this._hasDefinitionProvider = EditorContextKeys.hasDefinitionProvider.bindTo(
      _contextKeyService
    );
    _this._hasDeclarationProvider = EditorContextKeys.hasDeclarationProvider.bindTo(
      _contextKeyService
    );
    _this._hasImplementationProvider = EditorContextKeys.hasImplementationProvider.bindTo(
      _contextKeyService
    );
    _this._hasTypeDefinitionProvider = EditorContextKeys.hasTypeDefinitionProvider.bindTo(
      _contextKeyService
    );
    _this._hasHoverProvider = EditorContextKeys.hasHoverProvider.bindTo(
      _contextKeyService
    );
    _this._hasDocumentHighlightProvider = EditorContextKeys.hasDocumentHighlightProvider.bindTo(
      _contextKeyService
    );
    _this._hasDocumentSymbolProvider = EditorContextKeys.hasDocumentSymbolProvider.bindTo(
      _contextKeyService
    );
    _this._hasReferenceProvider = EditorContextKeys.hasReferenceProvider.bindTo(
      _contextKeyService
    );
    _this._hasRenameProvider = EditorContextKeys.hasRenameProvider.bindTo(
      _contextKeyService
    );
    _this._hasSignatureHelpProvider = EditorContextKeys.hasSignatureHelpProvider.bindTo(
      _contextKeyService
    );
    _this._hasDocumentFormattingProvider = EditorContextKeys.hasDocumentFormattingProvider.bindTo(
      _contextKeyService
    );
    _this._hasDocumentSelectionFormattingProvider = EditorContextKeys.hasDocumentSelectionFormattingProvider.bindTo(
      _contextKeyService
    );
    _this._hasMultipleDocumentFormattingProvider = EditorContextKeys.hasMultipleDocumentFormattingProvider.bindTo(
      _contextKeyService
    );
    _this._hasMultipleDocumentSelectionFormattingProvider = EditorContextKeys.hasMultipleDocumentSelectionFormattingProvider.bindTo(
      _contextKeyService
    );
    _this._isInWalkThrough = EditorContextKeys.isInEmbeddedEditor.bindTo(
      _contextKeyService
    );
    var update = function () {
    ...
    _this._register(
      modes.DocumentHighlightProviderRegistry.onDidChange(update)
    );
  ...
  EditorModeContext.prototype._update = function () {
    ...
    this._contextKeyService.bufferChangeEvents(function () {
      ...
      _this._hasCompletionItemProvider.set(
        modes.CompletionProviderRegistry.has(model)
      );
      _this._hasCodeActionsProvider.set(
        modes.CodeActionProviderRegistry.has(model)
      );
      _this._hasCodeLensProvider.set(modes.CodeLensProviderRegistry.has(model));
      _this._hasDefinitionProvider.set(
        modes.DefinitionProviderRegistry.has(model)
      );
      _this._hasDeclarationProvider.set(
        modes.DeclarationProviderRegistry.has(model)
      );
      _this._hasImplementationProvider.set(
        modes.ImplementationProviderRegistry.has(model)
      );
      _this._hasTypeDefinitionProvider.set(
        modes.TypeDefinitionProviderRegistry.has(model)
      );
      _this._hasHoverProvider.set(modes.HoverProviderRegistry.has(model));
      _this._hasDocumentHighlightProvider.set(
        modes.DocumentHighlightProviderRegistry.has(model)
      );
      _this._hasDocumentSymbolProvider.set(
        modes.DocumentSymbolProviderRegistry.has(model)
      );
      _this._hasReferenceProvider.set(
        modes.ReferenceProviderRegistry.has(model)
      );
      _this._hasRenameProvider.set(modes.RenameProviderRegistry.has(model));
      _this._hasSignatureHelpProvider.set(
        modes.SignatureHelpProviderRegistry.has(model)
      );
      _this._hasDocumentFormattingProvider.set(
        modes.DocumentFormattingEditProviderRegistry.has(model) ||
          modes.DocumentRangeFormattingEditProviderRegistry.has(model)
      );
      _this._hasDocumentSelectionFormattingProvider.set(
        modes.DocumentRangeFormattingEditProviderRegistry.has(model)
      );
      _this._hasMultipleDocumentFormattingProvider.set(
        modes.DocumentFormattingEditProviderRegistry.all(model).length +
          modes.DocumentRangeFormattingEditProviderRegistry.all(model).length >
          1
      );
      _this._hasMultipleDocumentSelectionFormattingProvider.set(
        modes.DocumentRangeFormattingEditProviderRegistry.all(model).length > 1
      );
      _this._isInWalkThrough.set(
...
var CodeEditorWidgetFocusTracker = /** @class */ (function (_super) {
  ...
  function CodeEditorWidgetFocusTracker(domElement) {
    ...
    _this._register(
      _this._domFocusTracker.onDidFocus(function () {
        _this._hasFocus = true;
        _this._onChange.fire(undefined);
      })
    );
    _this._register(
      _this._domFocusTracker.onDidBlur(function () {
        _this._hasFocus = false;
        _this._onChange.fire(undefined);
      })
    );
...
var squigglyEnd = encodeURIComponent(
...
var dotdotdotEnd = encodeURIComponent(
...
registerThemingParticipant(function (theme, collector) {
  ...
  if (errorBorderColor) {
    collector.addRule(
      '.monaco-editor .' +
      'squiggly-error' /* EditorErrorDecoration */ +
  ...
  if (errorForeground) {
    collector.addRule(
      ...
      'squiggly-error' /* EditorErrorDecoration */ +
        ...
        getSquigglySVGData(errorForeground) +
  ...
  if (warningBorderColor) {
    collector.addRule(
      '.monaco-editor .' +
      'squiggly-warning' /* EditorWarningDecoration */ +
        ' { border-bottom: 4px double ' +
        warningBorderColor +
        '; }'
    );
  ...
  if (warningForeground) {
    collector.addRule(
      ...
      'squiggly-warning' /* EditorWarningDecoration */ +
        ' { background: url("data:image/svg+xml,' +
        getSquigglySVGData(warningForeground) +
        '") repeat-x bottom left; }'
    );
  }
  ...
  if (infoBorderColor) {
    collector.addRule(
      '.monaco-editor .' +
      'squiggly-info' /* EditorInfoDecoration */ +
        ' { border-bottom: 4px double ' +
        infoBorderColor +
        '; }'
    );
  ...
  if (infoForeground) {
    collector.addRule(
      ...
      'squiggly-info' /* EditorInfoDecoration */ +
        ' { background: url("data:image/svg+xml,' +
        getSquigglySVGData(infoForeground) +
        '") repeat-x bottom left; }'
    );
  }
  ...
  if (hintBorderColor) {
    collector.addRule(
      '.monaco-editor .' +
      'squiggly-hint' /* EditorHintDecoration */ +
  ...
  if (hintForeground) {
    collector.addRule(
      ...
      'squiggly-hint' /* EditorHintDecoration */ +
        ' { background: url("data:image/svg+xml,' +
        getDotDotDotSVGData(hintForeground) +
  ...
  if (unnecessaryForeground) {
    collector.addRule(
      ...
      'squiggly-inline-unnecessary' /* EditorUnnecessaryInlineDecoration */ +
        ' { opacity: ' +
        unnecessaryForeground.rgba.a +
        '; }'
    );
  }
  ...
  if (unnecessaryBorder) {
    collector.addRule(
      '.monaco-editor.showUnused .' +
      'squiggly-unnecessary' /* EditorUnnecessaryDecoration */ +
  ...
  collector.addRule(
    '.monaco-editor .' +
    'squiggly-inline-deprecated' /* EditorDeprecatedInlineDecoration */ +
      ' { text-decoration: line-through; text-decoration-color: ' +
      deprecatedForeground +
      '}'
  );
});
