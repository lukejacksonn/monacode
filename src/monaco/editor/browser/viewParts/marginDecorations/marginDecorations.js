...
var MarginViewLineDecorationsOverlay = /** @class */ (function (_super) {
  ...
  MarginViewLineDecorationsOverlay.prototype.onConfigurationChanged = function (
    e
  ) {
    return true;
  };
  MarginViewLineDecorationsOverlay.prototype.onDecorationsChanged = function (
    e
  ) {
    return true;
  };
  ...
  MarginViewLineDecorationsOverlay.prototype.render = function (
    startLineNumber,
    lineNumber
  ) {
