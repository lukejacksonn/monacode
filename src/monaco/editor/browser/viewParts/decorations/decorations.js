...
var DecorationsOverlay = /** @class */ (function (_super) {
  ...
  DecorationsOverlay.prototype._renderWholeLineDecorations = function (
    ctx,
    decorations,
    output
  ) {
  ...
  DecorationsOverlay.prototype._renderNormalDecorations = function (
    ctx,
    decorations,
    output
  ) {
  ...
  DecorationsOverlay.prototype._renderNormalDecoration = function (
    ctx,
    range,
    className,
    showIfCollapsed,
    ...
    var linesVisibleRanges = ctx.linesVisibleRangesForRange(
      range,
