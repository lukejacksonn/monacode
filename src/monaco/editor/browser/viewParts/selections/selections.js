...
var SelectionsOverlay = /** @class */ (function (_super) {
  ...
  function SelectionsOverlay(context) {
    ...
    _this._typicalHalfwidthCharacterWidth = options.get(
      34 /* fontInfo */
  ...
  // --- end event handlers
  SelectionsOverlay.prototype._visibleRangesHaveGaps = function (
    linesVisibleRanges
  ) {
  ...
  SelectionsOverlay.prototype._enrichVisibleRangesWithStyle = function (
    viewport,
    linesVisibleRanges,
    previousFrame
  ) {
  ...
  SelectionsOverlay.prototype._getVisibleRangesWithStyle = function (
    selection,
    ctx,
    previousFrame
  ) {
    var _linesVisibleRanges =
  ...
  SelectionsOverlay.prototype._createSelectionPiece = function (
    top,
    height,
    className,
    left,
  ...
  SelectionsOverlay.prototype._actualRenderOneSelection = function (
    output2,
    ...
    for (var i = 0, len = visibleRanges.length; i < len; i++) {
      ...
      var lineHeight = hasMultipleSelections
        ? lineNumber === lastLineNumber || lineNumber === firstLineNumber
          ? reducedLineHeight
          : fullLineHeight
        : fullLineHeight;
      var top_1 = hasMultipleSelections
  ...
  SelectionsOverlay.prototype.prepareRender = function (ctx) {
    ...
    for (var i = 0, len = this._selections.length; i < len; i++) {
      ...
      var visibleRangesWithStyle = this._getVisibleRangesWithStyle(
        selection,
        ctx,
...
registerThemingParticipant(function (theme, collector) {
  ...
  var editorSelectionForegroundColor = theme.getColor(
    editorSelectionForeground
  );
  if (editorSelectionForegroundColor) {
    collector.addRule(
      '.monaco-editor .view-line span.inline-selected-text { color: ' +
