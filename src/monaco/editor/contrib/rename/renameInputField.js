...
export var CONTEXT_RENAME_INPUT_VISIBLE = new RawContextKey(
  'renameInputVisible',
  false
);
var RenameInputField = /** @class */ (function () {
  function RenameInputField(
    ...
    this._visibleContextKey = CONTEXT_RENAME_INPUT_VISIBLE.bindTo(
      contextKeyService
    );
    this._editor.addContentWidget(this);
    this._disposables.add(
      this._editor.onDidChangeConfiguration(function (e) {
    ...
    this._disposables.add(
      _themeService.onThemeChange(this._updateStyles, this)
    );
  }
  ...
  RenameInputField.prototype.getDomNode = function () {
    ...
    if (!this._domNode) {
      ...
      var updateLabel = function () {
        var _a, _b;
        var _c = _this._acceptKeybindings,
          accept = _c[0],
          preview = _c[1];
        _this._keybindingService.lookupKeybinding(accept);
        _this._label.innerText = localize(
          'label',
          '{0} to Rename, {1} to Preview',
          (_a = _this._keybindingService.lookupKeybinding(accept)) === null ||
            _a === void 0
            ? void 0
            : _a.getLabel(),
          (_b = _this._keybindingService.lookupKeybinding(preview)) === null ||
            _b === void 0
            ? void 0
            : _b.getLabel()
        );
      ...
      updateLabel();
      this._disposables.add(
        this._keybindingService.onDidUpdateKeybindings(updateLabel)
      );
      this._updateFont();
  ...
  RenameInputField.prototype._updateStyles = function (theme) {
    ...
    this._domNode.style.backgroundColor = String(
      (_a = theme.getColor(editorWidgetBackground)) !== null && _a !== void 0
        ? _a
        : ''
    );
    ...
    this._domNode.style.color = String(
      (_b = theme.getColor(inputForeground)) !== null && _b !== void 0 ? _b : ''
    );
    this._input.style.backgroundColor = String(
      (_c = theme.getColor(inputBackground)) !== null && _c !== void 0 ? _c : ''
    );
    ...
    this._input.style.borderColor =
      (_d =
        border === null || border === void 0 ? void 0 : border.toString()) !==
        null && _d !== void 0
        ? _d
        : 'none';
  };
  ...
  RenameInputField.prototype.getInput = function (
    where,
    value,
    selectionStart,
    selectionEnd,
    ...
    return new Promise(function (resolve) {
      ...
      _this._currentAcceptInput = function (wantsPreview) {
        if (
          _this._input.value.trim().length === 0 ||
  ...
  RenameInputField.prototype._show = function () {
    ...
    setTimeout(function () {
      _this._input.focus();
      _this._input.setSelectionRange(
        parseInt(_this._input.getAttribute('selectionStart')),
        parseInt(_this._input.getAttribute('selectionEnd'))
      );
    }, 100);
  };
