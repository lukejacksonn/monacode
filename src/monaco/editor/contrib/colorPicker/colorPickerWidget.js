...
var ColorPickerHeader = /** @class */ (function (_super) {
  ...
  function ColorPickerHeader(container, model, themeService) {
    ...
    colorBox.style.backgroundColor =
      Color.Format.CSS.format(_this.model.originalColor) || '';
    _this.backgroundColor =
      themeService.getTheme().getColor(editorHoverBackground) || Color.white;
    _this._register(
    ...
    _this._register(
      dom.addDisposableListener(colorBox, dom.EventType.CLICK, function () {
    ...
    _this._register(
      model.onDidChangePresentation(_this.onDidChangePresentation, _this)
    );
    _this.pickedColorNode.style.backgroundColor =
      Color.Format.CSS.format(model.color) || '';
    dom.toggleClass(
      _this.pickedColorNode,
      'light',
      model.color.rgba.a < 0.5
        ? _this.backgroundColor.isLighter()
        : model.color.isLighter()
    );
    return _this;
  }
  ColorPickerHeader.prototype.onDidChangeColor = function (color) {
    this.pickedColorNode.style.backgroundColor =
  ...
  ColorPickerHeader.prototype.onDidChangePresentation = function () {
    this.pickedColorNode.textContent = this.model.presentation
...
var ColorPickerBody = /** @class */ (function (_super) {
  ...
  function ColorPickerBody(container, model, pixelRatio) {
    ...
    dom.append(container, _this.domNode);
    _this.saturationBox = new SaturationBox(
      _this.domNode,
      _this.model,
      _this.pixelRatio
    );
    ...
    _this._register(
      _this.saturationBox.onDidChange(_this.onDidSaturationValueChange, _this)
    );
    _this._register(
      _this.saturationBox.onColorFlushed(_this.flushColor, _this)
    );
    _this.opacityStrip = new OpacityStrip(_this.domNode, _this.model);
    _this._register(_this.opacityStrip);
    _this._register(
      _this.opacityStrip.onDidChange(_this.onDidOpacityChange, _this)
    );
...
var SaturationBox = /** @class */ (function (_super) {
  ...
  function SaturationBox(container, model, pixelRatio) {
    ...
    _this.layout();
    _this._register(
      dom.addDisposableGenericMouseDownListner(_this.domNode, function (e) {
        return _this.onMouseDown(e);
      })
    );
    _this._register(
      _this.model.onDidChangeColor(_this.onDidChangeColor, _this)
    );
    _this.monitor = null;
    return _this;
  }
  SaturationBox.prototype.onMouseDown = function (e) {
    ...
    this.monitor.startMonitoring(
      ...
      standardMouseMoveMerger,
      function (event) {
        return _this.onDidChangePosition(
          event.posx - origin.left,
          event.posy - origin.top
        );
      },
      function () {
        return null;
    ...
    var mouseUpListener = dom.addDisposableGenericMouseUpListner(
      document,
      function () {
...
var OpacityStrip = /** @class */ (function (_super) {
  ...
  OpacityStrip.prototype.onDidChangeColor = function (color) {
    ...
    this.overlay.style.background =
      'linear-gradient(to bottom, ' + opaque + ' 0%, ' + transparent + ' 100%)';
  };
