...
export var SYMBOL_ICON_ARRAY_FOREGROUND = registerColor(
...
export var SYMBOL_ICON_BOOLEAN_FOREGROUND = registerColor(
...
export var SYMBOL_ICON_CLASS_FOREGROUND = registerColor(
...
export var SYMBOL_ICON_COLOR_FOREGROUND = registerColor(
...
export var SYMBOL_ICON_CONSTANT_FOREGROUND = registerColor(
...
export var SYMBOL_ICON_CONSTRUCTOR_FOREGROUND = registerColor(
...
export var SYMBOL_ICON_ENUMERATOR_FOREGROUND = registerColor(
...
export var SYMBOL_ICON_ENUMERATOR_MEMBER_FOREGROUND = registerColor(
...
export var SYMBOL_ICON_EVENT_FOREGROUND = registerColor(
...
export var SYMBOL_ICON_FIELD_FOREGROUND = registerColor(
...
export var SYMBOL_ICON_FILE_FOREGROUND = registerColor(
...
export var SYMBOL_ICON_FOLDER_FOREGROUND = registerColor(
...
export var SYMBOL_ICON_FUNCTION_FOREGROUND = registerColor(
...
export var SYMBOL_ICON_INTERFACE_FOREGROUND = registerColor(
...
export var SYMBOL_ICON_KEY_FOREGROUND = registerColor(
...
export var SYMBOL_ICON_KEYWORD_FOREGROUND = registerColor(
...
export var SYMBOL_ICON_METHOD_FOREGROUND = registerColor(
...
export var SYMBOL_ICON_MODULE_FOREGROUND = registerColor(
...
export var SYMBOL_ICON_NAMESPACE_FOREGROUND = registerColor(
...
export var SYMBOL_ICON_NULL_FOREGROUND = registerColor(
...
export var SYMBOL_ICON_NUMBER_FOREGROUND = registerColor(
...
export var SYMBOL_ICON_OBJECT_FOREGROUND = registerColor(
...
export var SYMBOL_ICON_OPERATOR_FOREGROUND = registerColor(
...
export var SYMBOL_ICON_PACKAGE_FOREGROUND = registerColor(
...
export var SYMBOL_ICON_PROPERTY_FOREGROUND = registerColor(
...
export var SYMBOL_ICON_REFERENCE_FOREGROUND = registerColor(
...
export var SYMBOL_ICON_SNIPPET_FOREGROUND = registerColor(
...
export var SYMBOL_ICON_STRING_FOREGROUND = registerColor(
...
export var SYMBOL_ICON_STRUCT_FOREGROUND = registerColor(
...
export var SYMBOL_ICON_TEXT_FOREGROUND = registerColor(
...
export var SYMBOL_ICON_TYPEPARAMETER_FOREGROUND = registerColor(
...
export var SYMBOL_ICON_UNIT_FOREGROUND = registerColor(
...
export var SYMBOL_ICON_VARIABLE_FOREGROUND = registerColor(
...
registerThemingParticipant(function (theme, collector) {
  ...
  if (symbolIconArrayColor) {
    collector.addRule(
      '.codicon-symbol-array { color: ' +
        symbolIconArrayColor +
        ' !important; }'
    );
  }
  ...
  if (symbolIconBooleanColor) {
    collector.addRule(
      '.codicon-symbol-boolean { color: ' +
        symbolIconBooleanColor +
        ' !important; }'
    );
  }
  ...
  if (symbolIconClassColor) {
    collector.addRule(
      '.codicon-symbol-class { color: ' +
        symbolIconClassColor +
        ' !important; }'
    );
  }
  ...
  if (symbolIconMethodColor) {
    collector.addRule(
      '.codicon-symbol-method { color: ' +
        symbolIconMethodColor +
        ' !important; }'
    );
  }
  ...
  if (symbolIconConstantColor) {
    collector.addRule(
      '.codicon-symbol-constant { color: ' +
        symbolIconConstantColor +
        ' !important; }'
    );
  }
  var symbolIconConstructorColor = theme.getColor(
    SYMBOL_ICON_CONSTRUCTOR_FOREGROUND
  );
  if (symbolIconConstructorColor) {
    collector.addRule(
      '.codicon-symbol-constructor { color: ' +
        symbolIconConstructorColor +
        ' !important; }'
    );
  }
  var symbolIconEnumeratorColor = theme.getColor(
    SYMBOL_ICON_ENUMERATOR_FOREGROUND
  );
  if (symbolIconEnumeratorColor) {
    collector.addRule(
      '\n\t\t\t.codicon-symbol-value,.codicon-symbol-enum { color: ' +
        symbolIconEnumeratorColor +
        ' !important; }'
    );
  }
  var symbolIconEnumeratorMemberColor = theme.getColor(
    SYMBOL_ICON_ENUMERATOR_MEMBER_FOREGROUND
  );
  if (symbolIconEnumeratorMemberColor) {
    collector.addRule(
      '.codicon-symbol-enum-member { color: ' +
  ...
  if (symbolIconEventColor) {
    collector.addRule(
      '.codicon-symbol-event { color: ' +
        symbolIconEventColor +
        ' !important; }'
    );
  }
  ...
  if (symbolIconFileColor) {
    collector.addRule(
      '.codicon-symbol-file { color: ' + symbolIconFileColor + ' !important; }'
    );
  }
  var symbolIconFolderColor = theme.getColor(SYMBOL_ICON_FOLDER_FOREGROUND);
  if (symbolIconFolderColor) {
    collector.addRule(
      '.codicon-symbol-folder { color: ' +
        symbolIconFolderColor +
        ' !important; }'
    );
  }
  ...
  if (symbolIconFunctionColor) {
    collector.addRule(
      '.codicon-symbol-function { color: ' +
        symbolIconFunctionColor +
        ' !important; }'
    );
  }
  var symbolIconInterfaceColor = theme.getColor(
    SYMBOL_ICON_INTERFACE_FOREGROUND
  );
  if (symbolIconInterfaceColor) {
    collector.addRule(
      '.codicon-symbol-interface { color: ' +
        symbolIconInterfaceColor +
        ' !important; }'
    );
  }
  ...
  if (symbolIconKeyColor) {
    collector.addRule(
      '.codicon-symbol-key { color: ' + symbolIconKeyColor + ' !important; }'
    );
  }
  var symbolIconKeywordColor = theme.getColor(SYMBOL_ICON_KEYWORD_FOREGROUND);
  if (symbolIconKeywordColor) {
    collector.addRule(
      '.codicon-symbol-keyword { color: ' +
        symbolIconKeywordColor +
        ' !important; }'
    );
  }
  ...
  if (symbolIconModuleColor) {
    collector.addRule(
      '.codicon-symbol-module { color: ' +
        symbolIconModuleColor +
        ' !important; }'
    );
  }
  ...
  if (outlineNamespaceColor) {
    collector.addRule(
      '.codicon-symbol-namespace { color: ' +
        outlineNamespaceColor +
        ' !important; }'
    );
  }
  ...
  if (symbolIconNullColor) {
    collector.addRule(
      '.codicon-symbol-null { color: ' + symbolIconNullColor + ' !important; }'
    );
  }
  var symbolIconNumberColor = theme.getColor(SYMBOL_ICON_NUMBER_FOREGROUND);
  if (symbolIconNumberColor) {
    collector.addRule(
      '.codicon-symbol-number { color: ' +
        symbolIconNumberColor +
        ' !important; }'
    );
  }
  ...
  if (symbolIconObjectColor) {
    collector.addRule(
      '.codicon-symbol-object { color: ' +
        symbolIconObjectColor +
        ' !important; }'
    );
  }
  ...
  if (symbolIconPackageColor) {
    collector.addRule(
      '.codicon-symbol-package { color: ' +
        symbolIconPackageColor +
        ' !important; }'
    );
  }
  ...
  if (symbolIconPropertyColor) {
    collector.addRule(
      '.codicon-symbol-property { color: ' +
        symbolIconPropertyColor +
        ' !important; }'
    );
  }
  var symbolIconReferenceColor = theme.getColor(
    SYMBOL_ICON_REFERENCE_FOREGROUND
  );
  if (symbolIconReferenceColor) {
    collector.addRule(
      '.codicon-symbol-reference { color: ' +
  ...
  if (symbolIconSnippetColor) {
    collector.addRule(
      '.codicon-symbol-snippet { color: ' +
        symbolIconSnippetColor +
        ' !important; }'
    );
  }
  ...
  if (symbolIconStructColor) {
    collector.addRule(
      '.codicon-symbol-struct { color: ' +
        symbolIconStructColor +
        ' !important; }'
    );
  }
  ...
  if (symbolIconTextColor) {
    collector.addRule(
      '.codicon-symbol-text { color: ' + symbolIconTextColor + ' !important; }'
    );
  }
  var symbolIconTypeParameterColor = theme.getColor(
    SYMBOL_ICON_TYPEPARAMETER_FOREGROUND
  );
  if (symbolIconTypeParameterColor) {
    collector.addRule(
      '.codicon-symbol-type-parameter { color: ' +
        symbolIconTypeParameterColor +
        ' !important; }'
    );
  }
  ...
  if (symbolIconUnitColor) {
    collector.addRule(
      '.codicon-symbol-unit { color: ' + symbolIconUnitColor + ' !important; }'
    );
  }
  var symbolIconVariableColor = theme.getColor(SYMBOL_ICON_VARIABLE_FOREGROUND);
  if (symbolIconVariableColor) {
    collector.addRule(
      '.codicon-symbol-variable { color: ' +
        symbolIconVariableColor +
        ' !important; }'
    );
  }
});
