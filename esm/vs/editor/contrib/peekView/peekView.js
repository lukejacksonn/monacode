...
var PeekViewWidget = /** @class */ (function (_super) {
  ...
  PeekViewWidget.prototype.setTitle = function (
    primaryHeading,
    secondaryHeading
  ) {
  ...
  PeekViewWidget.prototype._doLayout = function (heightInPixel, widthInPixel) {
    ...
    var headHeight = Math.ceil(
      this.editor.getOption(49 /* lineHeight */) * 1.2
    );
  ...
  PeekViewWidget.prototype._doLayoutHead = function (
    heightInPixel,
    widthInPixel
  ) {
  ...
  PeekViewWidget.prototype._doLayoutBody = function (
    heightInPixel,
    widthInPixel
  ) {
...
export var peekViewTitleBackground = registerColor(
...
export var peekViewResultsMatchForeground = registerColor(
...
export var peekViewResultsFileForeground = registerColor(
...
export var peekViewResultsSelectionBackground = registerColor(
...
export var peekViewResultsSelectionForeground = registerColor(
...
export var peekViewEditorBackground = registerColor(
...
export var peekViewEditorGutterBackground = registerColor(
...
export var peekViewResultsMatchHighlight = registerColor(
...
export var peekViewEditorMatchHighlight = registerColor(
...
export var peekViewEditorMatchHighlightBorder = registerColor(
