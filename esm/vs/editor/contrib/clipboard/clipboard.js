...
var supportsPaste =
  platform.isNative ||
  (!browser.isChrome && document.queryCommandSupported('paste'));
...
var ExecCommandCutAction = /** @class */ (function (_super) {
  ...
  ExecCommandCutAction.prototype.run = function (accessor, editor) {
    ...
    var emptySelectionClipboard = editor.getOption(
...
var ExecCommandCopyWithSyntaxHighlightingAction = /** @class */ (function (
  _super
) {
  ...
  ExecCommandCopyWithSyntaxHighlightingAction.prototype.run = function (
    accessor,
    editor
  ) {
    if (!editor.hasModel()) {
