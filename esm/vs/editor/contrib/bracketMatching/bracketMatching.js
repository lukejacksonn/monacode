...
var overviewRulerBracketMatchForeground = registerColor(
  'editorOverviewRuler.bracketMatchForeground',
  { dark: '#A0A0A0', light: '#A0A0A0', hc: '#A0A0A0' },
  nls.localize(
    ...
    return (
      _super.call(this, {
        ...
        kbOpts: {
          ...
          primary:
            2048 /* CtrlCmd */ | 1024 /* Shift */ | 88 /* US_BACKSLASH */,
...
var BracketMatchingController = /** @class */ (function (_super) {
  ...
  function BracketMatchingController(editor) {
    ...
    _this._decorations = [];
    _this._updateBracketsSoon = _this._register(
    ...
    _this._register(
      editor.onDidChangeModelLanguageConfiguration(function (e) {
        _this._lastBracketsData = [];
        _this._updateBracketsSoon.schedule();
      })
    );
    _this._register(
      editor.onDidChangeConfiguration(function (e) {
        if (e.hasChanged(53 /* matchBrackets */)) {
          _this._matchBrackets = _this._editor.getOption(
            53 /* matchBrackets */
          );
          _this._decorations = _this._editor.deltaDecorations(
            _this._decorations,
            []
          );
          _this._lastBracketsData = [];
    ...
    this._editor.getSelections().forEach(function (selection) {
      ...
      if (brackets) {
        ...
        selectFrom = selectBrackets
          ? open_1.getStartPosition()
          : open_1.getEndPosition();
        selectTo = selectBrackets
          ? close_1.getEndPosition()
...
registerThemingParticipant(function (theme, collector) {
  ...
  if (bracketMatchBackground) {
    collector.addRule(
      '.monaco-editor .bracket-match { background-color: ' +
  ...
  if (bracketMatchBorder) {
    collector.addRule(
      '.monaco-editor .bracket-match { border: 1px solid ' +
        bracketMatchBorder +
        '; }'
    );
  }
