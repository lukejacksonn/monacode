...
import {
  ...
  FoldingRangeKind,
} from '../../common/modes.js';
import {
  SyntaxRangeProvider,
  ID_SYNTAX_PROVIDER,
} from './syntaxRangeProvider.js';
import {
  InitializingRangeProvider,
  ID_INIT_PROVIDER,
} from './intializingRangeProvider.js';
...
var FoldingController = /** @class */ (function (_super) {
  ...
  function FoldingController(editor, contextKeyService) {
    ...
    _this._useFoldingProviders =
      options.get(31 /* foldingStrategy */) !== 'indentation';
    ...
    _this.foldingDecorationProvider.autoHideFoldingControls =
      options.get(84 /* showFoldingControls */) === 'mouseover';
    _this.foldingDecorationProvider.showFoldingHighlights = options.get(
      32 /* foldingHighlight */
    );
    _this.foldingEnabled = CONTEXT_FOLDING_ENABLED.bindTo(
    ...
    _this._register(
      _this.editor.onDidChangeConfiguration(function (e) {
        ...
        if (
          e.hasChanged(84 /* showFoldingControls */) ||
          e.hasChanged(32 /* foldingHighlight */)
        ) {
          var options_2 = _this.editor.getOptions();
          _this.foldingDecorationProvider.autoHideFoldingControls =
            options_2.get(84 /* showFoldingControls */) === 'mouseover';
          _this.foldingDecorationProvider.showFoldingHighlights = options_2.get(
            32 /* foldingHighlight */
          );
        ...
        if (e.hasChanged(31 /* foldingStrategy */)) {
          ...
          _this._useFoldingProviders =
            options_3.get(31 /* foldingStrategy */) !== 'indentation';
  ...
  FoldingController.prototype.saveViewState = function () {
    ...
    if (this.foldingModel) {
      // disposed ?
      var collapsedRegions = this.foldingModel.isInitialized
        ? this.foldingModel.getMemento()
  ...
  FoldingController.prototype.restoreViewState = function (state) {
    ...
    if (
      state.provider === ID_SYNTAX_PROVIDER ||
      state.provider === ID_INIT_PROVIDER
    ) {
  ...
  FoldingController.prototype.onModelChanged = function () {
    ...
    this.localToDispose.add(
      this.hiddenRangeModel.onDidChange(function (hr) {
    ...
    this.localToDispose.add(
      FoldingRangeProviderRegistry.onDidChange(function () {
        return _this.onFoldingStrategyChanged();
      })
    );
    this.localToDispose.add(
      this.editor.onDidChangeModelLanguageConfiguration(function () {
        return _this.onFoldingStrategyChanged();
      })
  ...
  FoldingController.prototype.getRangeProvider = function (editorModel) {
    ...
    if (this._useFoldingProviders && this.foldingModel) {
      var foldingProviders = FoldingRangeProviderRegistry.ordered(
        this.foldingModel.textModel
      );
      if (
        foldingProviders.length === 0 &&
        this.foldingStateMemento &&
        this.foldingStateMemento.collapsedRegions
      ) {
        var rangeProvider = (this.rangeProvider = new InitializingRangeProvider(
          editorModel,
          this.foldingStateMemento.collapsedRegions,
          function () {
    ...
    if (this.updateScheduler) {
      ...
      this.foldingModelPromise = this.updateScheduler
        .trigger(function () {
          ...
          var foldingRegionPromise = (_this.foldingRegionPromise = createCancelablePromise(
            function (token) {
              return _this
                .getRangeProvider(foldingModel.textModel)
                .compute(token);
            }
          ));
        ...
        if (foldingModel) {
          ...
          if (selections && selections.length > 0) {
            ...
            var _loop_1 = function (selection) {
              ...
              if (
                _this.hiddenRangeModel &&
                _this.hiddenRangeModel.isHidden(lineNumber)
              ) {
                toToggle.push.apply(
                  toToggle,
                  foldingModel.getAllRegionsAtLine(lineNumber, function (r) {
        ...
        if (foldingModel) {
          ...
          if (region && region.startLineNumber === lineNumber) {
            ...
            if (iconClicked || isCollapsed) {
              ...
              if (recursive) {
                for (
                  var _i = 0, _a = foldingModel.getRegionsInside(region);
                  _i < _a.length;
                  _i++
                ) {
                  var r = _a[_i];
...
function foldingArgumentsConstraint(args) {
  if (!types.isUndefined(args)) {
    ...
    if (
      ...
      (!types.isArray(foldingArgs.selectionLines) ||
...
var UnfoldAction = /** @class */ (function (_super) {
  ...
  UnfoldAction.prototype.invoke = function (
    _foldingController,
    foldingModel,
    editor,
    args
...
var UnFoldRecursivelyAction = /** @class */ (function (_super) {
    ...
    return (
      _super.call(this, {
        ...
        kbOpts: {
          kbExpr: EditorContextKeys.editorTextFocus,
          primary: KeyChord(
            2048 /* CtrlCmd */ | 41 /* KEY_K */,
            2048 /* CtrlCmd */ | 89 /* US_CLOSE_SQUARE_BRACKET */
          ),
          weight: 100 /* EditorContrib */,
        },
      }) || this
  ...
  UnFoldRecursivelyAction.prototype.invoke = function (
    _foldingController,
    foldingModel,
    editor,
    _args
...
var FoldAction = /** @class */ (function (_super) {
  ...
  FoldAction.prototype.invoke = function (
    _foldingController,
    foldingModel,
    editor,
    args
...
var ToggleFoldAction = /** @class */ (function (_super) {
  ...
  ToggleFoldAction.prototype.invoke = function (
    _foldingController,
    foldingModel,
    editor
  ) {
...
var FoldRecursivelyAction = /** @class */ (function (_super) {
    ...
    return (
      _super.call(this, {
        ...
        kbOpts: {
          ...
          primary: KeyChord(
            2048 /* CtrlCmd */ | 41 /* KEY_K */,
            2048 /* CtrlCmd */ | 87 /* US_OPEN_SQUARE_BRACKET */
          ),
          weight: 100 /* EditorContrib */,
        },
      }) || this
  ...
  FoldRecursivelyAction.prototype.invoke = function (
    _foldingController,
    foldingModel,
    editor
  ) {
...
var FoldAllBlockCommentsAction = /** @class */ (function (_super) {
  ...
  FoldAllBlockCommentsAction.prototype.invoke = function (
    _foldingController,
    foldingModel,
    editor
  ) {
    if (foldingModel.regions.hasTypes()) {
      ...
      var comments = LanguageConfigurationRegistry.getComments(
        editorModel.getLanguageIdentifier().id
      );
...
var FoldAllRegionsAction = /** @class */ (function (_super) {
  ...
  FoldAllRegionsAction.prototype.invoke = function (
    _foldingController,
    foldingModel,
    editor
  ) {
    if (foldingModel.regions.hasTypes()) {
      ...
      var foldingRules = LanguageConfigurationRegistry.getFoldingRules(
        editorModel.getLanguageIdentifier().id
      );
...
var UnfoldAllRegionsAction = /** @class */ (function (_super) {
  ...
  UnfoldAllRegionsAction.prototype.invoke = function (
    _foldingController,
    foldingModel,
    editor
  ) {
...
var FoldAllAction = /** @class */ (function (_super) {
  ...
  FoldAllAction.prototype.invoke = function (
    _foldingController,
    foldingModel,
    _editor
  ) {
...
var UnfoldAllAction = /** @class */ (function (_super) {
  ...
  UnfoldAllAction.prototype.invoke = function (
    _foldingController,
    foldingModel,
    _editor
  ) {
...
var FoldLevelAction = /** @class */ (function (_super) {
  ...
  FoldLevelAction.prototype.invoke = function (
    _foldingController,
    foldingModel,
    editor
  ) {
...
export var foldBackgroundBackground = registerColor(
...
registerThemingParticipant(function (theme, collector) {
  ...
  if (foldBackground) {
    collector.addRule(
      '.monaco-editor .folded-background { background-color: ' +
        foldBackground +
        '; }'
    );
  }
