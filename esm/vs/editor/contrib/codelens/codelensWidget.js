...
var CodeLensWidget = /** @class */ (function () {
  ...
  CodeLensWidget.prototype.getCommand = function (link) {
    var _a;
    return (_a = this._contentWidget) === null || _a === void 0
      ? void 0
      : _a.getCommand(link);
  };
  CodeLensWidget.prototype.getLineNumber = function () {
    var range = this._editor
      .getModel()
...
registerThemingParticipant(function (theme, collector) {
  ...
  if (codeLensForeground) {
    collector.addRule(
      '.monaco-editor .codelens-decoration { color: ' +
        codeLensForeground +
        '; }'
    );
    collector.addRule(
      '.monaco-editor .codelens-decoration .codicon { color: ' +
        codeLensForeground +
        '; }'
    );
  }
  ...
  if (activeLinkForeground) {
    collector.addRule(
      '.monaco-editor .codelens-decoration > a:hover { color: ' +
        activeLinkForeground +
        ' !important; }'
    );
    collector.addRule(
      '.monaco-editor .codelens-decoration > a:hover .codicon { color: ' +
        activeLinkForeground +
        ' !important; }'
    );
  }
