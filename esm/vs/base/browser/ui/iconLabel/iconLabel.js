  ...
  function IconLabel(container, options) {
    ...
    if (
      options === null || options === void 0
        ? void 0
        : options.supportHighlights
    ) {
      _this.nameNode = new LabelWithHighlights(
        nameContainer,
        !!options.supportCodicons
      );
    } else {
    ...
    if (
      options === null || options === void 0
        ? void 0
        : options.supportDescriptionHighlights
    ) {
      _this.descriptionNodeFactory = function () {
        return new HighlightedLabel(
          dom.append(
            _this.descriptionContainer.element,
  ...
  Label.prototype.setLabel = function (label, options) {
    ...
    if (typeof label === 'string') {
      ...
      for (var i = 0; i < label.length; i++) {
        var l = label[i];
        var id =
          (options === null || options === void 0 ? void 0 : options.domId) &&
          (options === null || options === void 0 ? void 0 : options.domId) +
            '_' +
            i;
        dom.append(
  ...
  LabelWithHighlights.prototype.setLabel = function (label, options) {
    ...
    if (typeof label === 'string') {
      if (!this.singleLabel) {
        this.container.innerHTML = '';
        dom.removeClass(this.container, 'multiple');
        this.singleLabel = new HighlightedLabel(
          dom.append(
            this.container,
            dom.$('a.label-name', {
              id:
      ...
      this.singleLabel.set(
        label,
        options === null || options === void 0 ? void 0 : options.matches,
        options === null || options === void 0 ? void 0 : options.title,
        options === null || options === void 0
          ? void 0
      ...
      for (var i = 0; i < label.length; i++) {
        ...
        var highlightedLabel = new HighlightedLabel(
          dom.append(this.container, name_1),
          this.supportCodicons
        );
        ...
        if (i < label.length - 1) {
          dom.append(
            name_1,
            dom.$('span.label-separator', undefined, separator)
          );
        }
      }
    }
