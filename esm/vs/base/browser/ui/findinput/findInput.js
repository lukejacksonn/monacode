...
var FindInput = /** @class */ (function (_super) {
  ...
  function FindInput(parent, contextViewProvider, _showOptionButtons, options) {
    ...
    _this.inputValidationErrorForeground =
      options.inputValidationErrorForeground;
    ...
    _this.inputBox = _this._register(
      new HistoryInputBox(_this.domNode, _this.contextViewProvider, {
    ...
    _this._register(
      _this.regex.onChange(function (viaKeyboard) {
    ...
    _this._register(
      _this.regex.onKeyDown(function (e) {
        _this._onRegexKeyDown.fire(e);
      })
    );
    _this.wholeWords = _this._register(
    ...
    _this._register(
      _this.wholeWords.onChange(function (viaKeyboard) {
        _this._onDidOptionChange.fire(viaKeyboard);
        if (!viaKeyboard && _this.fixFocusOnOptionClickEnabled) {
          _this.inputBox.focus();
        }
    ...
    _this.caseSensitive = _this._register(
    ...
    _this._register(
      _this.caseSensitive.onChange(function (viaKeyboard) {
        _this._onDidOptionChange.fire(viaKeyboard);
        if (!viaKeyboard && _this.fixFocusOnOptionClickEnabled) {
          _this.inputBox.focus();
        }
    ...
    _this._register(
      _this.caseSensitive.onKeyDown(function (e) {
        _this._onCaseSensitiveKeyDown.fire(e);
      })
    );
    if (_this._showOptionButtons) {
      _this.inputBox.paddingRight =
        _this.caseSensitive.width() +
        _this.wholeWords.width() +
        _this.regex.width();
    }
