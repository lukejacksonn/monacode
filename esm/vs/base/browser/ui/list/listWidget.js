...
var TraitRenderer = /** @class */ (function () {
  ...
  TraitRenderer.prototype.renderElement = function (
    element,
    index,
    templateData
  ) {
...
var Trait = /** @class */ (function () {
  ...
  Trait.prototype.splice = function (start, deleteCount, elements) {
    ...
    var indexes = __spreadArrays(
      this.sortedIndexes.filter(function (i) {
        return i < start;
      }),
      elements
        .map(function (hasTrait, i) {
  ...
  Trait.prototype.set = function (indexes, browserEvent) {
    return this._set(
      indexes,
      __spreadArrays(indexes).sort(numericSort),
      browserEvent
    );
  };
...
var TraitSpliceable = /** @class */ (function () {
  ...
  TraitSpliceable.prototype.splice = function (start, deleteCount, elements) {
    ...
    var elementsWithTrait = elements.map(function (e) {
      return (
        pastElementsWithTrait.indexOf(
          _this.identityProvider.getId(e).toString()
        ) > -1
      );
    });
...
export var DefaultKeyboardNavigationDelegate = new /** @class */ ((function () {
  ...
  class_1.prototype.mightProducePrintableCharacter = function (event) {
    ...
    return (
      (event.keyCode >= 31 /* KEY_A */ && event.keyCode <= 56) /* KEY_Z */ ||
      (event.keyCode >= 21 /* KEY_0 */ && event.keyCode <= 30) /* KEY_9 */ ||
      (event.keyCode >= 93 /* NUMPAD_0 */ &&
        event.keyCode <= 102) /* NUMPAD_9 */ ||
      (event.keyCode >= 80 /* US_SEMICOLON */ &&
        event.keyCode <= 90) /* US_QUOTE */
    );
  };
  return class_1;
})())();
var TypeLabelController = /** @class */ (function () {
  function TypeLabelController(
    list,
    view,
  ...
  TypeLabelController.prototype.updateOptions = function (options) {
    var enableKeyboardNavigation =
      typeof options.enableKeyboardNavigation === 'undefined'
        ? true
  ...
  TypeLabelController.prototype.onInput = function (word) {
    ...
    for (var i = 0; i < this.list.length; i++) {
      ...
      var label = this.keyboardNavigationLabelProvider.getKeyboardNavigationLabel(
...
var MouseController = /** @class */ (function () {
  function MouseController(list) {
    this.list = list;
    this.disposables = new DisposableStore();
    this.multipleSelectionSupport = !(
      list.options.multipleSelectionSupport === false
    );
    ...
    this.mouseSupport =
      typeof list.options.mouseSupport === 'undefined' ||
      !!list.options.mouseSupport;
  ...
  MouseController.prototype.isSelectionChangeEvent = function (event) {
    return (
      this.isSelectionSingleChangeEvent(event) ||
      this.isSelectionRangeChangeEvent(event)
    );
  };
  ...
  MouseController.prototype.changeSelection = function (e, reference) {
    ...
    if (this.isSelectionRangeChangeEvent(e) && reference !== undefined) {
      ...
      var selection = this.list.getSelection();
      var contiguousRange = getContiguousRangeContaining(
      ...
      if (selection.length === newSelection.length) {
        this.list.setSelection(
          __spreadArrays(newSelection, [focus]),
          e.browserEvent
        );
      } else {
        this.list.setSelection(newSelection, e.browserEvent);
  ...
  DefaultStyleController.prototype.style = function (styles) {
    ...
    if (styles.listFocusBackground) {
      content.push(
        '.monaco-list' +
          suffix +
          ':focus .monaco-list-row.focused { background-color: ' +
          styles.listFocusBackground +
          '; }'
      );
      content.push(
        '.monaco-list' +
          suffix +
          ':focus .monaco-list-row.focused:hover { background-color: ' +
          styles.listFocusBackground +
          '; }'
    ...
    if (styles.listFocusForeground) {
      content.push(
        '.monaco-list' +
          suffix +
          ':focus .monaco-list-row.focused { color: ' +
          styles.listFocusForeground +
          '; }'
      );
    }
    if (styles.listActiveSelectionBackground) {
      content.push(
        '.monaco-list' +
          suffix +
          ':focus .monaco-list-row.selected { background-color: ' +
          styles.listActiveSelectionBackground +
          '; }'
      );
      content.push(
        '.monaco-list' +
          suffix +
          ':focus .monaco-list-row.selected:hover { background-color: ' +
          styles.listActiveSelectionBackground +
          '; }'
      ); // overwrite :hover style in this case!
    }
    if (styles.listActiveSelectionForeground) {
      content.push(
        '.monaco-list' +
          suffix +
          ':focus .monaco-list-row.selected { color: ' +
          styles.listActiveSelectionForeground +
          '; }'
      );
    }
    if (styles.listFocusAndSelectionBackground) {
      content.push(
        '\n\t\t\t\t.monaco-drag-image,\n\t\t\t\t.monaco-list' +
          ...
          styles.listFocusAndSelectionBackground +
          '; }\n\t\t\t'
      );
    }
    if (styles.listFocusAndSelectionForeground) {
      content.push(
        '\n\t\t\t\t.monaco-drag-image,\n\t\t\t\t.monaco-list' +
          ...
          styles.listFocusAndSelectionForeground +
          '; }\n\t\t\t'
      );
    }
    if (styles.listInactiveFocusBackground) {
      content.push(
        '.monaco-list' +
          suffix +
          ' .monaco-list-row.focused { background-color:  ' +
          styles.listInactiveFocusBackground +
          '; }'
      );
      content.push(
        '.monaco-list' +
          suffix +
          ' .monaco-list-row.focused:hover { background-color:  ' +
          styles.listInactiveFocusBackground +
          '; }'
      ); // overwrite :hover style in this case!
    }
    if (styles.listInactiveSelectionBackground) {
      content.push(
        '.monaco-list' +
          suffix +
          ' .monaco-list-row.selected { background-color:  ' +
          styles.listInactiveSelectionBackground +
          '; }'
      );
      content.push(
        '.monaco-list' +
          suffix +
          ' .monaco-list-row.selected:hover { background-color:  ' +
          styles.listInactiveSelectionBackground +
          '; }'
      ); // overwrite :hover style in this case!
    }
    if (styles.listInactiveSelectionForeground) {
      content.push(
        '.monaco-list' +
          suffix +
          ' .monaco-list-row.selected { color: ' +
          styles.listInactiveSelectionForeground +
          '; }'
      );
    }
    if (styles.listHoverBackground) {
      content.push(
        '.monaco-list' +
          suffix +
          ':not(.drop-target) .monaco-list-row:hover:not(.selected):not(.focused) { background-color:  ' +
    ...
    if (styles.listHoverForeground) {
      content.push(
        '.monaco-list' +
          suffix +
          ' .monaco-list-row:hover:not(.selected):not(.focused) { color:  ' +
          styles.listHoverForeground +
          '; }'
      );
    }
    if (styles.listSelectionOutline) {
      content.push(
        '.monaco-list' +
          suffix +
          ' .monaco-list-row.selected { outline: 1px dotted ' +
    ...
    if (styles.listInactiveFocusOutline) {
      content.push(
        '.monaco-list' +
          suffix +
          ' .monaco-list-row.focused { outline: 1px dotted ' +
    ...
    if (styles.listDropBackground) {
      content.push(
        '\n\t\t\t\t.monaco-list' +
          ...
          '.drop-target,\n\t\t\t\t.monaco-list' +
          suffix +
          ' .monaco-list-rows.drop-target,\n\t\t\t\t.monaco-list' +
          suffix +
          ' .monaco-list-row.drop-target { background-color: ' +
          styles.listDropBackground +
    ...
    if (styles.listFilterWidgetOutline) {
      content.push(
        '.monaco-list-type-filter { border: 1px solid ' +
          styles.listFilterWidgetOutline +
          '; }'
      );
    }
    if (styles.listFilterWidgetNoMatchesOutline) {
      content.push(
        '.monaco-list-type-filter.no-matches { border: 1px solid ' +
          styles.listFilterWidgetNoMatchesOutline +
          '; }'
      );
    }
...
var PipelineRenderer = /** @class */ (function () {
  ...
  PipelineRenderer.prototype.renderElement = function (
    element,
    index,
    templateData,
    height
  ...
  PipelineRenderer.prototype.disposeElement = function (
    element,
    index,
    templateData,
    height
...
var AccessibiltyRenderer = /** @class */ (function () {
  ...
  AccessibiltyRenderer.prototype.renderElement = function (
    element,
    index,
    container
  ) {
...
var ListViewDragAndDrop = /** @class */ (function () {
  ...
  ListViewDragAndDrop.prototype.getDragLabel = function (
    elements,
    originalEvent
  ) {
  ...
  ListViewDragAndDrop.prototype.onDragOver = function (
    data,
    targetElement,
    targetIndex,
    originalEvent
  ...
  ListViewDragAndDrop.prototype.drop = function (
    data,
    targetElement,
    targetIndex,
    originalEvent
...
var List = /** @class */ (function () {
  function List(user, container, virtualDelegate, renderers, _options) {
    ...
    renderers = renderers.map(function (r) {
      return new PipelineRenderer(
        r.templateId,
        __spreadArrays(baseRenderers, [r])
      );
    });
    ...
    this.onDidFocus = Event.map(
      domEvent(this.view.domNode, 'focus', true),
      function () {
        return null;
      }
    );
    this.onDidBlur = Event.map(
      domEvent(this.view.domNode, 'blur', true),
      function () {
        return null;
      }
    );
    ...
    if (
      typeof _options.keyboardSupport !== 'boolean' ||
      _options.keyboardSupport
    ) {
    ...
    if (_options.keyboardNavigationLabelProvider) {
      var delegate =
        _options.keyboardNavigationDelegate ||
        DefaultKeyboardNavigationDelegate;
      this.typeLabelController = new TypeLabelController(
        this,
        this.view,
  ...
  Object.defineProperty(List.prototype, 'onContextMenu', {
    get: function () {
      ...
      var fromKeyup = Event.chain(domEvent(this.view.domNode, 'keyup'))
        ...
        .filter(function () {
          return (
            _this.getFocus().length > 0 &&
            !!_this.view.domElement(_this.getFocus()[0])
          );
        })
      ...
      var fromMouse = Event.chain(this.view.onContextMenu)
        ...
        .map(function (_a) {
          ...
          return {
            element: element,
            index: index,
            anchor: { x: browserEvent.clientX + 1, y: browserEvent.clientY },
            browserEvent: browserEvent,
          };
        }).event;
  ...
  List.prototype.focusPrevious = function (n, loop, browserEvent, filter) {
    ...
    var focus = this.focus.get();
    var index = this.findPreviousIndex(
      focus.length > 0 ? focus[0] - n : 0,
      loop,
      filter
    );
  ...
  List.prototype.focusNextPage = function (browserEvent, filter) {
    var _this = this;
    var lastPageIndex = this.view.indexAt(
    ...
    if (currentlyFocusedElement !== lastPageElement) {
      var lastGoodPageIndex = this.findPreviousIndex(
        lastPageIndex,
        false,
        filter
      );
      if (
        lastGoodPageIndex > -1 &&
        currentlyFocusedElement !== this.view.element(lastGoodPageIndex)
      ) {
  ...
  List.prototype.focusPreviousPage = function (browserEvent, filter) {
    ...
    if (currentlyFocusedElement !== firstPageElement) {
      var firstGoodPageIndex = this.findNextIndex(
        firstPageIndex,
        false,
        filter
      );
      if (
        firstGoodPageIndex > -1 &&
        currentlyFocusedElement !== this.view.element(firstGoodPageIndex)
      ) {
  ...
  List.prototype.onDidChangeActiveDescendant = function () {
    ...
    if (focus.length > 0) {
      var id = void 0;
      if (
        (_a = this.accessibilityProvider) === null || _a === void 0
          ? void 0
          : _a.getActiveDescendantId
      ) {
